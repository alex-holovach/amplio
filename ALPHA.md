...
- `amplio paths` — writes the `~telemetry/*` tsconfig path alias (JSONC-comment-safe) and nothing else. `amplio init --paths` still works when you want the alias as part of a full init.
